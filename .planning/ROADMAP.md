...
- [ ] 01-01-PLAN.md — Scaffold Next.js 16 + pinned deps (legitimacy gate) + dark app shell per UI-SPEC

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 01-02-PLAN.md — TDD validation rules (SSRF gate) + full 5-table roadmap schema + db client + drizzle config

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 01-03-PLAN.md — Neon provisioning + [BLOCKING] drizzle-kit push + COMP-01 add/list vertical slice

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 01-04-PLAN.md — COMP-02 edit (reconcile-by-id) + delete with confirmation dialog

**Wave 5** *(blocked on Wave 4 completion)*

- [ ] 01-05-PLAN.md — GitHub push + Vercel deploy (env vars before first deploy) + production E2E verification
...
|-------|----------------|--------|-----------|
| 1. Foundation & Competitor Management | 0/5 | Planned | - |
...
*Phase 1 planned: 2026-07-03 (5 plans, 5 waves)*
